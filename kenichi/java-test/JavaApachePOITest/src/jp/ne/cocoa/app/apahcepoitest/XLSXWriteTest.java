/**
 * 2017-04-22 kenichi つつじヶ丘駅前のドトールにて
 * 以下URLを参考にした。
 * http://qiita.com/tool-taro/items/4b3c802bb114a9110ecb
 * なお、Apache-POIのライブラリは「/Work/poi」に解凍した構成でそのまま格納している。
 * http://ftp.riken.jp/net/apache/poi/release/bin/poi-bin-3.16-20170419.tar.gz
 */
